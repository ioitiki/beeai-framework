...
async function* toAsyncGenerator(promise) {
  yield await promise;
}
__name(toAsyncGenerator, "toAsyncGenerator");
var _Symbol_toStringTag;

export { LazyPromise, arrayFromAsync, asyncExecute, asyncProperties, emitterToGenerator, executeSequentially, isPromiseLike, safeExecute, signalRace, toAsyncGenerator };
